...
class QualityTest {
    @Test
    fun testLevels() {
        fun Quality.result(): String = "$this: ${level.niceStr}: $isLow, $isMedium, $isHigh : ${this <= Quality.MEDIUM}, ${this >= Quality.MEDIUM}"

        assertEquals(
            """
                LOWEST: 0: true, false, false : true, false
                ...
                HIGHEST: 1: false, false, true : false, true
            """.trimIndent(),
            """
