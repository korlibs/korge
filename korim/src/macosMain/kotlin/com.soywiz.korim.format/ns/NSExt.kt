...
fun CValue<NSPoint>.toPoint(): MPoint = useContents { MPoint(this.x, this.y) }
fun CValue<NSRect>.toRectangle(): MRectangle = useContents { MRectangle(this.origin.x, this.origin.y, this.size.width, this.size.height) }
