...
REM CALL gradlew.bat --no-daemon mingwX64Test localPublishToBintrayIfRequiredOnTravisReleaseTagNoPR
CALL gradlew.bat --no-daemon localPublishToBintrayIfRequiredOnTravisReleaseTagNoPR
