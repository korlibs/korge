...
val kotlinVersion: String = project.kotlinVersion
val realKotlinVersion = project.realKotlinVersion
val nodeVersion: String = project.nodeVersion
val androidBuildGradleVersion: String = project.androidBuildGradleVersion
val forcedVersion = System.getenv("FORCED_VERSION")

RootKorlibsPlugin(project)
