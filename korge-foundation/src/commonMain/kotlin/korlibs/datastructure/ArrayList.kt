...
typealias FloatList = IFloatArrayList
typealias DoubleList = IDoubleArrayList
...
interface IFloatArrayList : Collection<Float> {
 ...
 */
@Suppress("UNCHECKED_CAST")
class FloatArrayList(capacity: Int = 7) : IFloatArrayList {
    companion object { }
