...
fun SpatialMeshFind.funnel(p0: IPoint, p1: IPoint): PointList = find(p0, p1)

fun Iterable<Triangle>.funnel(p0: IPoint, p1: IPoint): PointList = this.pathFind().funnel(p0, p1)
fun Iterable<Triangle>.pathFind(p0: IPoint, p1: IPoint): PointList = this.pathFind().funnel(p0, p1)
...
fun Shape2d.pathFind(p0: IPoint, p1: IPoint): PointList = this.triangulateFlat().pathFind().funnel(p0, p1)
...
fun VectorPath.pathFind(p0: IPoint, p1: IPoint): PointList = this.triangulateSafe().pathFind().funnel(p0, p1)
