...
class BezierCurveTest {
    ...
    fun testBezierBoundingBox() {
        assertEquals(
            ...
            Bezier(
                MPoint(-4.044654662829129, -61.366911337359305),
                MPoint(-3.2722813703417932, -61.83588230138613),
                MPoint(-2.398578099496581, -62.06241698807055),
                MPoint(-1.4319231077369396, -62.06241698807055),
    ...
    fun testSelfIntersections() {
        ...
        assertEquals(
            listOf(),
            Bezier(MPoint(0, 0), MPoint(-50, -200), MPoint(150, 150), MPoint(110, 120)).selfIntersections().toList()
        )
    }
    ...
    fun testReduce() {
        ...
        assertEquals(
            listOf(
                Bezier(
                    MPoint(0.0, 0.0),
                    MPoint(0.0, -18.25000000000001),
                    MPoint(6.661250000000008, -29.838750000000015),
                    MPoint(15.121037500000018, -34.766250000000014),
                ),
                Bezier(
                    MPoint(15.121037500000018, -34.766250000000014),
                    MPoint(18.250000000000014, -36.588750000000005),
                    MPoint(21.625000000000007, -37.5),
                    MPoint(25.0, -37.5),
                ),
                Bezier(
                    MPoint(25.0, -37.5 ),
                    MPoint(32.125, -37.5 ),
                    MPoint(39.25, -33.43875 ),
                    MPoint(44.0600875, -25.31624999999999)
                ),
                Bezier(
                    MPoint(44.0600875, -25.31624999999999),
                    MPoint(47.68875, -19.188749999999988),
                    MPoint(50.0, -10.749999999999993),
                    MPoint(50, 0)
                )
            ),
            curves.map { it.curve }
    ...
    fun testProjectsOntoTheCorrectOnCurvePoint() {
        ...
        assertEquals(
            Bezier.ProjectedPoint(p = MPoint(75, 25), t = 0.5, dSq = 50.0),
            b.project(MPoint(80, 20))
        )
    }
