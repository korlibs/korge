...
class Matrix3Test {
    ...
    fun testRows() {
        ...
        assertEquals(Vector3(1f, 2f, 3f), m.r0)
        assertEquals(Vector3(-4f, -5f, -6f), m.r1)
        assertEquals(Vector3(7f, -8f, 9f), m.r2)
        assertEquals(m.r0, m.r(0))
        assertEquals(m.r1, m.r(1))
        assertEquals(m.r2, m.r(2))

        assertEquals(Vector3(1f, -4f, 7f), m.c0)
        assertEquals(Vector3(2f, -5f, -8f), m.c1)
        assertEquals(Vector3(3f, -6f, 9f), m.c2)
        assertEquals(m.c0, m.c(0))
        assertEquals(m.c1, m.c(1))
        assertEquals(m.c2, m.c(2))

        assertEquals(m.c0, Vector3(m.v00, m.v10, m.v20))
        assertEquals(m.c1, Vector3(m.v01, m.v11, m.v21))
        assertEquals(m.c2, Vector3(m.v02, m.v12, m.v22))

        assertEquals(Vector3(m[0, 0], m[1, 0], m[2, 0]), Vector3(m.v00, m.v01, m.v02))
        assertEquals(Vector3(m[0, 1], m[1, 1], m[2, 1]), Vector3(m.v10, m.v11, m.v12))
        assertEquals(Vector3(m[0, 2], m[1, 2], m[2, 2]), Vector3(m.v20, m.v21, m.v22))
    }
    ...
    fun testColumns() {
        ...
        assertEquals(Vector3(1f, 2f, 3f), m.c0)
        assertEquals(Vector3(-4f, -5f, -6f), m.c1)
        assertEquals(Vector3(7f, -8f, 9f), m.c2)
    }
