package korlibs.datastructure.internal.js
...
internal fun bigInt64ArrayOf(vararg values: JsBigInt): BigInt64Array {
    return BigInt64Array(values.size).also { for (n in values.indices) it[n] = values[n] }
}
internal operator fun BigInt64Array.get(index: Int): JsBigInt = JsBigInt(asDynamic()[index])
internal operator fun BigInt64Array.set(index: Int, value: JsBigInt) { asDynamic()[index] = JsBigInt(value) }

internal fun JsBigInt.toLong(): Long {
