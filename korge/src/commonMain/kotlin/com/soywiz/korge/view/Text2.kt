...
inline fun Container.text2(
    text: String, textSize: Double = Text2.DEFAULT_TEXT_SIZE,
    ...
    autoScaling: Boolean = Text2.DEFAULT_AUTO_SCALING,
    fill: Paint? = null, stroke: Stroke? = null,
    block: @ViewDslMarker Text2.() -> Unit = {}
): Text2
    = Text2(text, textSize, color, font, alignment, renderer, autoScaling, fill, stroke).addTo(this, block)
...
open class Text2(
    ...
    override var font: Resourceable<out Font> = font; set(value) {
        if (field != value) {
            field = value
            version++
            invalidate()
    ...
    override var textSize: Double = textSize; set(value) {
        if (field != value) {
            field = value
            version++
            invalidate()
    ...
    override fun getGlyphMetrics(): TextMetricsResult {
        _renderInternal(null)
...
fun <T : Text2> T.autoSize(value: Boolean): T {
    this.autoSize = value
    return this
}
...
fun <T : Text2> T.aroundPath(path: VectorPath?): T {
    aroundPath = path
    return this
}

var <T : Text2> T.aroundPath: VectorPath?
    get() {
