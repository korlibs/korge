...
class RenderContext2D(
    ...
    @PublishedApi internal fun getTransformedScissor(scissor: AGScissor): AGScissor {
        val left = m.transformX(scissor.left.toFloat(), scissor.top.toFloat())
        val top = m.transformY(scissor.left.toFloat(), scissor.top.toFloat())
        val right = m.transformX(scissor.right.toFloat(), scissor.bottom.toFloat())
        val bottom = m.transformY(scissor.right.toFloat(), scissor.bottom.toFloat())
