...
val DefaultTextSkin by lazy {
    TextSkin(
        normal = TextFormat(RGBA(0, 0, 0), 16, DefaultUIFont),
        over = TextFormat(RGBA(80, 80, 80), 16, DefaultUIFont),
        down = TextFormat(RGBA(120, 120, 120), 16, DefaultUIFont),
        disabled = TextFormat(RGBA(160, 160, 160), 16, DefaultUIFont),
...
val DefaultIconSkins by lazy {
    (0 until 5).map {
        IconSkin(
            normal = DEFAULT_UI_SKIN_IMG.sliceWithSize(0, 64 * (it + 1), 64, 64),
            disabled = DEFAULT_UI_SKIN_IMG.sliceWithSize(64, 64 * (it + 1), 64, 64)
        )
    }

}

val DefaultCheckSkin get() = DefaultIconSkins[0]
val DefaultUpSkin get() = DefaultIconSkins[1]
val DefaultRightSkin get() = DefaultIconSkins[2]
val DefaultDownSkin get() = DefaultIconSkins[3]
val DefaultLeftSkin get() = DefaultIconSkins[4]
