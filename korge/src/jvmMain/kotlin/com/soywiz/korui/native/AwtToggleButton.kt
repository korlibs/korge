...
internal open class AwtToggleButton(factory: BaseAwtUiFactory, val button: JToggleButton = JToggleButton()) : AwtComponent(factory, button), NativeUiFactory.NativeToggleButton {
