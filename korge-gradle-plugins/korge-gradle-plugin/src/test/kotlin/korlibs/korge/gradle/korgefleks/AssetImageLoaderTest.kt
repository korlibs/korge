...
class AssetImageLoaderTest {
    ...
    fun testImageFrameDuration() {
        ...
        assertEquals("Expect correct \"Testnum\" frame 0 duration", 242, spriteTestnumFrames[0]["d"])
        assertEquals("Expect correct \"Testnum\" frame 1 duration", 200, spriteTestnumFrames[1]["d"])
        assertEquals("Expect correct \"Testnum\" frame 2 duration", 200, spriteTestnumFrames[8]["d"])
        assertEquals("Expect correct \"Testnum\" frame 3 duration", 242, spriteTestnumFrames[9]["d"])

        assertEquals("Expect correct \"Firetrail\" frame 0 duration", 40, spriteFiretrailFrames[0]["d"])
        assertEquals("Expect correct \"Firetrail\" frame 1 duration", 41, spriteFiretrailFrames[1]["d"])
        assertEquals("Expect correct \"Firetrail\" frame 2 duration", 42, spriteFiretrailFrames[2]["d"])
        assertEquals("Expect correct \"Firetrail\" frame 3 duration", 40, spriteFiretrailFrames[3]["d"])
        assertEquals("Expect correct \"Firetrail\" frame 20 duration", 40, spriteFiretrailFrames[20]["d"])
        assertEquals("Expect correct \"Firetrail\" frame 21 duration", 41, spriteFiretrailFrames[21]["d"])
        assertEquals("Expect correct \"Firetrail\" frame 22 duration", 42, spriteFiretrailFrames[22]["d"])
    }
}
