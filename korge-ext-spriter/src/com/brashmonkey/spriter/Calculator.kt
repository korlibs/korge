...
object Calculator {
	 ...
	 */
	@JvmStatic fun angleDifference(a: Float, b: Float): Float {
	 ...
	 */
	@JvmStatic fun angleBetween(x1: Float, y1: Float, x2: Float, y2: Float): Float {
	 ...
	 */
	@JvmStatic fun solveCubic(a: Float, b: Float, c: Float, d: Float): Float {
		var b = b
		var c = c
		var d = d
	 ...
	 */
	@JvmStatic fun solveQuadratic(a: Float, b: Float, c: Float): Float {
		val squaredB = squared(b)
		val twoA = 2 * a
		val fourAC = 4f * a * c
	 ...
	 */
	@JvmStatic fun squared(f: Float): Float {
		return f * f
	}
	 ...
	 */
	@JvmStatic fun cubed(f: Float): Float {
		return f * f * f
	}
	 ...
	 */
	@JvmStatic fun cubicRoot(f: Float): Float {
		return pow(f.toDouble(), (1f / 3f).toDouble()).toFloat()
	}
	 ...
	 */
	@JvmStatic fun sqrt(x: Float): Float {
	 ...
	 */
	@JvmStatic fun acos(x: Float): Float {
