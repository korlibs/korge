...
object Interpolator {
	...
	@JvmStatic fun linear(a: Float, b: Float, t: Float): Float {
		return a + (b - a) * t
	}

	@JvmStatic fun linearAngle(a: Float, b: Float, t: Float): Float {
		return a + Calculator.angleDifference(b, a) * t
	}

	@JvmStatic fun quadratic(a: Float, b: Float, c: Float, t: Float): Float {
		return linear(linear(a, b, t), linear(b, c, t), t)
	}

	@JvmStatic fun quadraticAngle(a: Float, b: Float, c: Float, t: Float): Float {
		return linearAngle(linearAngle(a, b, t), linearAngle(b, c, t), t)
	}

	@JvmStatic fun cubic(a: Float, b: Float, c: Float, d: Float, t: Float): Float {
		return linear(quadratic(a, b, c, t), quadratic(b, c, d, t), t)
	}

	@JvmStatic fun cubicAngle(a: Float, b: Float, c: Float, d: Float, t: Float): Float {
		return linearAngle(quadraticAngle(a, b, c, t), quadraticAngle(b, c, d, t), t)
	}

	@JvmStatic fun quartic(a: Float, b: Float, c: Float, d: Float, e: Float, t: Float): Float {
		return linear(cubic(a, b, c, d, t), cubic(b, c, d, e, t), t)
	}

	@JvmStatic fun quarticAngle(a: Float, b: Float, c: Float, d: Float, e: Float, t: Float): Float {
		return linearAngle(cubicAngle(a, b, c, d, t), cubicAngle(b, c, d, e, t), t)
	}

	@JvmStatic fun quintic(a: Float, b: Float, c: Float, d: Float, e: Float, f: Float, t: Float): Float {
		return linear(quartic(a, b, c, d, e, t), quartic(b, c, d, e, f, t), t)
	}

	@JvmStatic fun quinticAngle(a: Float, b: Float, c: Float, d: Float, e: Float, f: Float, t: Float): Float {
		return linearAngle(quarticAngle(a, b, c, d, e, t), quarticAngle(b, c, d, e, f, t), t)
	}

	@JvmStatic fun bezier(t: Float, x1: Float, x2: Float, x3: Float, x4: Float): Float {
