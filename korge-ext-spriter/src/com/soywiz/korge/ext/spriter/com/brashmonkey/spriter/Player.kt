...
(entity: Entity) {
	...
	@JvmField var _entity: Entity = Entity.DUMMY
	@JvmField var _animation: Animation = Animation.DUMMY
	@JvmField var _time: Int = 0
	var speed: Int = 15
	 ...
	 */
	fun flippedX(): Int {
		return Math.signum(root.scale.x).toInt()
	}
	 ...
	 */
	fun flippedY(): Int {
		return Math.signum(root.scale.y).toInt()
	}
