...
private val Long.high: Int get() = (this ushr 32).toInt()
private val Long.low: Int get() = this.toInt()
private fun Long.Companion.fromLowHigh(low: Int, high: Int): Long = (low.toLong() and 0xFFFFFFFFL) or (high.toLong() shl 32)
