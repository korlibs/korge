...
class StorageItem<T>(val storage: IStorage, val clazz: Class<T>, val key: String, val gen: () -> T) {
...
inline fun <reified T> IStorage.item(key: String, noinline gen: () -> T) = StorageItem(this, T::class.java, key, gen)
