...
val Buffer.arrayByte: Int8Array get() = Int8Array(buffer)
val Buffer.arrayShort: Int16Array get() = Int16Array(buffer)
val Buffer.arrayInt: Int32Array get() = Int32Array(buffer)
val Buffer.arrayFloat: Float32Array get() = Float32Array(buffer)
val Buffer.arrayDouble: Float64Array get() = Float64Array(buffer)
val Buffer.arrayBuffer: ArrayBuffer get() = this.buffer
val Buffer.arrayUByte: Uint8Array get() = Uint8Array(this.buffer)
