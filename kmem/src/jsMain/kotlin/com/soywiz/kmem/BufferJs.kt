...
actual inline operator fun Int8Buffer.set(index: Int, value: Byte): Unit { this.asDynamic()[index] = value }
...
actual inline operator fun Int16Buffer.set(index: Int, value: Short): Unit { this.asDynamic()[index] = value }
...
actual inline operator fun Int32Buffer.set(index: Int, value: Int): Unit { this.asDynamic()[index] = value }
...
actual inline operator fun Float32Buffer.set(index: Int, value: Float): Unit { this.asDynamic()[index] = value }
...
actual inline operator fun Float64Buffer.set(index: Int, value: Double): Unit { this.asDynamic()[index] = value }
...
actual fun arraycopy(src: Int8Buffer, srcPos: Int, dst: Int8Buffer, dstPos: Int, size: Int): Unit {
    if (src !== dst && size <= 128) {
...
/** Copies [size] elements of [src] starting at [srcPos] into [dst] at [dstPos]  */
actual fun arraycopy(src: ByteArray, srcPos: Int, dst: Int8Buffer, dstPos: Int, size: Int): Unit {
    if (size <= 128) {
        for (n in 0 until size) dst[dstPos + n] = src[srcPos + n]
        return
    }
...
/** Copies [size] elements of [src] starting at [srcPos] into [dst] at [dstPos]  */
actual fun arraycopy(src: Int8Buffer, srcPos: Int, dst: ByteArray, dstPos: Int, size: Int): Unit {
    if (size <= 128) {
        for (n in 0 until size) dst[dstPos + n] = src[srcPos + n]
        return
    }
...
/** Copies [size] elements of [src] starting at [srcPos] into [dst] at [dstPos]  */
actual fun arraycopy(src: Int16Buffer, srcPos: Int, dst: Int16Buffer, dstPos: Int, size: Int): Unit {
    if (src !== dst && size <= 128) {
        for (n in 0 until size) dst[dstPos + n] = src[srcPos + n]
        return
    }
...
/** Copies [size] elements of [src] starting at [srcPos] into [dst] at [dstPos]  */
actual fun arraycopy(src: ShortArray, srcPos: Int, dst: Int16Buffer, dstPos: Int, size: Int): Unit {
    if (size <= 128) {
        for (n in 0 until size) dst[dstPos + n] = src[srcPos + n]
        return
    }
...
/** Copies [size] elements of [src] starting at [srcPos] into [dst] at [dstPos]  */
actual fun arraycopy(src: Int16Buffer, srcPos: Int, dst: ShortArray, dstPos: Int, size: Int): Unit {
    if (size <= 128) {
        for (n in 0 until size) dst[dstPos + n] = src[srcPos + n]
        return
    }
...
/** Copies [size] elements of [src] starting at [srcPos] into [dst] at [dstPos]  */
actual fun arraycopy(src: Int32Buffer, srcPos: Int, dst: Int32Buffer, dstPos: Int, size: Int): Unit {
    if (src !== dst && size <= 128) {
        for (n in 0 until size) dst[dstPos + n] = src[srcPos + n]
        return
    }
...
/** Copies [size] elements of [src] starting at [srcPos] into [dst] at [dstPos]  */
actual fun arraycopy(src: IntArray, srcPos: Int, dst: Int32Buffer, dstPos: Int, size: Int): Unit {
    if (size <= 128) {
        for (n in 0 until size) dst[dstPos + n] = src[srcPos + n]
        return
    }
...
/** Copies [size] elements of [src] starting at [srcPos] into [dst] at [dstPos]  */
actual fun arraycopy(src: Int32Buffer, srcPos: Int, dst: IntArray, dstPos: Int, size: Int): Unit {
    if (size <= 128) {
        for (n in 0 until size) dst[dstPos + n] = src[srcPos + n]
        return
    }
...
/** Copies [size] elements of [src] starting at [srcPos] into [dst] at [dstPos]  */
actual fun arraycopy(src: Float32Buffer, srcPos: Int, dst: Float32Buffer, dstPos: Int, size: Int): Unit {
    if (src !== dst && size <= 128) {
        for (n in 0 until size) dst[dstPos + n] = src[srcPos + n]
        return
    }
...
/** Copies [size] elements of [src] starting at [srcPos] into [dst] at [dstPos]  */
actual fun arraycopy(src: FloatArray, srcPos: Int, dst: Float32Buffer, dstPos: Int, size: Int): Unit {
    if (size <= 128) {
        for (n in 0 until size) dst[dstPos + n] = src[srcPos + n]
        return
    }
...
/** Copies [size] elements of [src] starting at [srcPos] into [dst] at [dstPos]  */
actual fun arraycopy(src: Float32Buffer, srcPos: Int, dst: FloatArray, dstPos: Int, size: Int): Unit {
    if (size <= 128) {
        for (n in 0 until size) dst[dstPos + n] = src[srcPos + n]
        return
    }
...
/** Copies [size] elements of [src] starting at [srcPos] into [dst] at [dstPos]  */
actual fun arraycopy(src: Float64Buffer, srcPos: Int, dst: Float64Buffer, dstPos: Int, size: Int): Unit {
    if (src !== dst && size <= 128) {
        for (n in 0 until size) dst[dstPos + n] = src[srcPos + n]
        return
    }
...
/** Copies [size] elements of [src] starting at [srcPos] into [dst] at [dstPos]  */
actual fun arraycopy(src: DoubleArray, srcPos: Int, dst: Float64Buffer, dstPos: Int, size: Int): Unit {
    if (size <= 128) {
        for (n in 0 until size) dst[dstPos + n] = src[srcPos + n]
        return
    }
...
/** Copies [size] elements of [src] starting at [srcPos] into [dst] at [dstPos]  */
actual fun arraycopy(src: Float64Buffer, srcPos: Int, dst: DoubleArray, dstPos: Int, size: Int): Unit {
    if (size <= 128) {
        for (n in 0 until size) dst[dstPos + n] = src[srcPos + n]
        return
    }
