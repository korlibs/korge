    ...
    */
	...
	init {
        ...
        unlock = {
            ...
            document.removeEventListener("keydown", unlock, true.toJsBoolean())
            document.removeEventListener("touchstart", unlock, true.toJsBoolean())
            document.removeEventListener("touchend", unlock, true.toJsBoolean())
            document.removeEventListener("mousedown", unlock, true.toJsBoolean())
		...
		document.addEventListener("keydown", unlock, true.toJsBoolean())
		document.addEventListener("touchstart", unlock, true.toJsBoolean())
		document.addEventListener("touchend", unlock, true.toJsBoolean())
		document.addEventListener("mousedown", unlock, true.toJsBoolean())
	}
}
