<h1 align="center">KorGE (Maintenance mode)</h1>
...
**In maintenance mode. [Soywiz](https://github.com/soywiz) (the founder/primary lead/developer) has retired from maintaining this project (2023/07/27).** 
