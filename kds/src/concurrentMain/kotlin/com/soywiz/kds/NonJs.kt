...
actual inline operator fun <T> FastIntMap<T>.set(key: Int, value: T): Unit { (this as IntMap<T>).set(key, value) }
actual inline operator fun <T> FastIntMap<T>.contains(key: Int): Boolean = (this as IntMap<T>).contains(key)
actual inline fun <T> FastIntMap<T>.remove(key: Int): Unit { (this as IntMap<T>).remove(key) }
...
actual inline operator fun <T> FastStringMap<T>.set(key: String, value: T): Unit { (this.map).set(key, value) }
actual inline operator fun <T> FastStringMap<T>.contains(key: String): Boolean = (this.map).contains(key)
actual inline fun <T> FastStringMap<T>.remove(key: String): Unit { (this.map).remove(key) }
