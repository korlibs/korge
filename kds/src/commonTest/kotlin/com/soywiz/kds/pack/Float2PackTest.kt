...
class Float2PackTest {
    ...
    fun testCompareValue() {
        assertTrue("zeroEquals") { Float2Pack(0f, 0f) == Float2Pack(0f, 0f) }
    }

    @Test
    fun testCompareObject() {
        assertEquals(Float2Pack(0f, 0f), Float2Pack(0f, 0f))
    }
    ...
    fun performanceTest() {
        ...
        for (n in 0 until 100000000) {
            val pack1 = Float2Pack(100f * n, 200f)
            val pack2 = Float2Pack(-33f, -77f * n)
            sum += pack1.x + pack1.y
            sum += pack2.x + pack2.y
            //assertEquals(300f, pack1.x + pack1.y)
            //assertEquals(-110f, pack2.x + pack2.y)
