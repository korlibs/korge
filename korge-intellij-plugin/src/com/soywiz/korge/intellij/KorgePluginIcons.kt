...
object KorgePluginIcons {
	val PARTICLE_ICON by lazy { IconLoader.getIcon("/com/soywiz/korge/intellij/icon/particle.png") }
	val BITMAP_FONT_ICON by lazy { IconLoader.getIcon("/com/soywiz/korge/intellij/icon/bitmap_font.png") }
