...
class MP2 : JSMpegDecoderBase() {
    ...
    constructor(options) {
        ...
        var bufferMode = if (options.streaming) JSMpeg.BitBuffer.MODE.EVICT else JSMpeg.BitBuffer.MODE.EXPAND;
    ...
    companion object {
        ...
        val SCALEFACTOR_BASE = uintArrayOf(
            0x02000000, 0x01965FEA, 0x01428A30
        );

        val SYNTHESIS_WINDOW = floatArrayOf(
        ...
        val MP2.QUANT_LUT_STEP_1 = arrayOf(
