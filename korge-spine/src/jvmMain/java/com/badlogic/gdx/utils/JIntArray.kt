...
public class JIntArray {
    ...
    public JIntArray(boolean ordered, int capacity) {
     ...
     * grown. */
    public JIntArray(JIntArray array) {
     ...
     * @param ordered If false, methods that remove elements may change the order of other elements in the array, which avoids a
     *           memory copy. */
    public JIntArray(boolean ordered, int[] array, int startIndex, int count) {
        this(ordered, count);
        size = count;
    ...
    public boolean removeAll (JIntArray array) {
        int size = this.size;
        int startSize = size;
        int[] items = this.items;
    ...
    public boolean equals (Object object) {
        ...
        if (!(object instanceof JIntArray)) return false;
    ...
    /** @see #JIntArray(int[]) */
    static public JIntArray with (int... array) {
        return new JIntArray(array);
    }
}
