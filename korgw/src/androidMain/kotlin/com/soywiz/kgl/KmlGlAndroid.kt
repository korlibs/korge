...
class KmlGlAndroid(val clientVersion: () -> Int) : KmlGlWithExtensions() {
    ...
    override fun bufferData(target: Int, size: Int, data: Buffer, usage: Int): Unit = glBufferData(target, size, data.directBuffer, usage)
    override fun bufferSubData(target: Int, offset: Int, size: Int, data: Buffer): Unit = glBufferSubData(target, offset, size, data.directBuffer)
    ...
    override fun compressedTexImage2D(target: Int, level: Int, internalformat: Int, width: Int, height: Int, border: Int, imageSize: Int, data: Buffer): Unit = glCompressedTexImage2D(target, level, internalformat, width, height, border, imageSize, data.directBuffer)
    override fun compressedTexSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int, width: Int, height: Int, format: Int, imageSize: Int, data: Buffer): Unit = glCompressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, imageSize, data.directBuffer)
    ...
    override fun readPixels(x: Int, y: Int, width: Int, height: Int, format: Int, type: Int, pixels: Buffer): Unit = glReadPixels(x, y, width, height, format, type, pixels.directBuffer)
    ...
    override fun shaderBinary(count: Int, shaders: Buffer, binaryformat: Int, binary: Buffer, length: Int): Unit = glShaderBinary(count, shaders.directIntBuffer, binaryformat, binary.directBuffer, length)
    ...
    override fun texImage2D(target: Int, level: Int, internalformat: Int, width: Int, height: Int, border: Int, format: Int, type: Int, pixels: Buffer?): Unit = glTexImage2D(target, level, internalformat, width, height, border, format, type, pixels?.directBuffer)
    override fun texImage2D(target: Int, level: Int, internalformat: Int, format: Int, type: Int, data: NativeImage) {
        val out = java.nio.ByteBuffer.allocateDirect(data.width * data.height * 4)
    ...
    override fun texSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int, width: Int, height: Int, format: Int, type: Int, pixels: Buffer): Unit = glTexSubImage2D(target, level, xoffset, yoffset, width, height, format, type, pixels.directBuffer)
