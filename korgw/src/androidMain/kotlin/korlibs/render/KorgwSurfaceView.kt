...
open class KorgwSurfaceView constructor(
    ...
    fun onKey(keyCode: Int, event: KeyEvent, type: korlibs.event.KeyEvent.Type, long: Boolean): Boolean {
    ...
    override fun onKeyDown(keyCode: Int, event: KeyEvent): Boolean {
        ...
        return onKey(keyCode, event, type = korlibs.event.KeyEvent.Type.DOWN, long = false)
    }

    override fun onKeyLongPress(keyCode: Int, event: KeyEvent): Boolean {
        //println("KorgwSurfaceView.onKeyLongPress")
        return onKey(keyCode, event, type = korlibs.event.KeyEvent.Type.DOWN, long = true)
    }
    ...
    override fun onKeyMultiple(keyCode: Int, repeatCount: Int, event: KeyEvent): Boolean {
        ...
        for (char in event.characters) {
            onKey(char.toInt(), event, type = korlibs.event.KeyEvent.Type.TYPE, long = false)
        }
        return true
    }
