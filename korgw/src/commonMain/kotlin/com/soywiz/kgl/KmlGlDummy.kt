...
open class KmlGlDummyBase : KmlGl() {
    ...
    override fun bufferData(target: Int, size: Int, data: NBuffer, usage: Int): Unit = Unit
    override fun bufferSubData(target: Int, offset: Int, size: Int, data: NBuffer): Unit = Unit
    ...
    override fun compressedTexImage2D(target: Int, level: Int, internalformat: Int, width: Int, height: Int, border: Int, imageSize: Int, data: NBuffer): Unit = Unit
    override fun compressedTexSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int, width: Int, height: Int, format: Int, imageSize: Int, data: NBuffer): Unit = Unit
    ...
    private fun delete(n: Int, buffer: NBuffer, allocator: Allocator) {
        for (i in 0 until n) allocator.free(buffer.i32[i])
    }
    override fun deleteBuffers(n: Int, items: NBuffer): Unit = delete(n, items, bufferIds)
    override fun deleteFramebuffers(n: Int, items: NBuffer): Unit = delete(n, items, frameBufferIds)
    override fun deleteProgram(program: Int): Unit = programIds.free(program)
    override fun deleteRenderbuffers(n: Int, items: NBuffer): Unit = delete(n, items, renderBufferIds)
    override fun deleteShader(shader: Int): Unit = shaderIds.free(shader)
    override fun deleteTextures(n: Int, items: NBuffer): Unit = delete(n, items, textureIds)
    ...
    private fun gen(n: Int, buffer: NBuffer, allocator: Allocator) {
        for (i in 0 until n) buffer.i32[i] = allocator.alloc()
    }
    override fun genBuffers(n: Int, buffers: NBuffer): Unit = gen(n, buffers, bufferIds)
    override fun generateMipmap(target: Int): Unit = Unit
    override fun genFramebuffers(n: Int, framebuffers: NBuffer): Unit = gen(n, framebuffers, frameBufferIds)
    override fun genRenderbuffers(n: Int, renderbuffers: NBuffer): Unit = gen(n, renderbuffers, renderBufferIds)
    override fun genTextures(n: Int, textures: NBuffer): Unit = gen(n, textures, textureIds)

    override fun getActiveAttrib(program: Int, index: Int, bufSize: Int, length: NBuffer, size: NBuffer, type: NBuffer, name: NBuffer): Unit = Unit
    override fun getActiveUniform(program: Int, index: Int, bufSize: Int, length: NBuffer, size: NBuffer, type: NBuffer, name: NBuffer): Unit = Unit
    override fun getAttachedShaders(program: Int, maxCount: Int, count: NBuffer, shaders: NBuffer): Unit = Unit
    ...
    override fun getBooleanv(pname: Int, data: NBuffer): Unit = Unit
    override fun getBufferParameteriv(target: Int, pname: Int, params: NBuffer): Unit = Unit
    override fun getError(): Int = 0
    override fun getFloatv(pname: Int, data: NBuffer): Unit = Unit
    override fun getFramebufferAttachmentParameteriv(target: Int, attachment: Int, pname: Int, params: NBuffer): Unit = Unit
    override fun getIntegerv(pname: Int, data: NBuffer): Unit = Unit
    override fun getProgramInfoLog(program: Int, bufSize: Int, length: NBuffer, infoLog: NBuffer): Unit = Unit
    override fun getRenderbufferParameteriv(target: Int, pname: Int, params: NBuffer): Unit = Unit
    override fun getProgramiv(program: Int, pname: Int, params: NBuffer): Unit = Unit
    override fun getShaderiv(shader: Int, pname: Int, params: NBuffer) {
        when (pname) {
            COMPILE_STATUS -> params.i32[0] = GTRUE
        }
    }
    override fun getShaderInfoLog(shader: Int, bufSize: Int, length: NBuffer, infoLog: NBuffer): Unit = Unit
    override fun getShaderPrecisionFormat(shadertype: Int, precisiontype: Int, range: NBuffer, precision: NBuffer): Unit = Unit
    override fun getShaderSource(shader: Int, bufSize: Int, length: NBuffer, source: NBuffer): Unit = Unit
    override fun getString(name: Int): String = ""
    override fun getTexParameterfv(target: Int, pname: Int, params: NBuffer): Unit = Unit
    override fun getTexParameteriv(target: Int, pname: Int, params: NBuffer): Unit = Unit
    override fun getUniformfv(program: Int, location: Int, params: NBuffer): Unit = Unit
    override fun getUniformiv(program: Int, location: Int, params: NBuffer): Unit = Unit
    override fun getVertexAttribfv(index: Int, pname: Int, params: NBuffer): Unit = Unit
    override fun getVertexAttribiv(index: Int, pname: Int, params: NBuffer): Unit = Unit
    override fun getVertexAttribPointerv(index: Int, pname: Int, pointer: NBuffer): Unit = Unit
    ...
    override fun readPixels(x: Int, y: Int, width: Int, height: Int, format: Int, type: Int, pixels: NBuffer): Unit = Unit
    ...
    override fun shaderBinary(count: Int, shaders: NBuffer, binaryformat: Int, binary: NBuffer, length: Int): Unit = Unit
    ...
    override fun texImage2D(target: Int, level: Int, internalformat: Int, width: Int, height: Int, border: Int, format: Int, type: Int, pixels: NBuffer?): Unit = Unit
    ...
    override fun texParameterfv(target: Int, pname: Int, params: NBuffer): Unit = Unit
    override fun texParameteri(target: Int, pname: Int, param: Int): Unit = Unit
    override fun texParameteriv(target: Int, pname: Int, params: NBuffer): Unit = Unit
    override fun texSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int, width: Int, height: Int, format: Int, type: Int, pixels: NBuffer): Unit = Unit
    override fun uniform1f(location: Int, v0: Float): Unit = Unit
    override fun uniform1fv(location: Int, count: Int, value: NBuffer): Unit = Unit
    override fun uniform1i(location: Int, v0: Int): Unit = Unit
    override fun uniform1iv(location: Int, count: Int, value: NBuffer): Unit = Unit
    override fun uniform2f(location: Int, v0: Float, v1: Float): Unit = Unit
    override fun uniform2fv(location: Int, count: Int, value: NBuffer): Unit = Unit
    override fun uniform2i(location: Int, v0: Int, v1: Int): Unit = Unit
    override fun uniform2iv(location: Int, count: Int, value: NBuffer): Unit = Unit
    override fun uniform3f(location: Int, v0: Float, v1: Float, v2: Float): Unit = Unit
    override fun uniform3fv(location: Int, count: Int, value: NBuffer): Unit = Unit
    override fun uniform3i(location: Int, v0: Int, v1: Int, v2: Int): Unit = Unit
    override fun uniform3iv(location: Int, count: Int, value: NBuffer): Unit = Unit
    override fun uniform4f(location: Int, v0: Float, v1: Float, v2: Float, v3: Float): Unit = Unit
    override fun uniform4fv(location: Int, count: Int, value: NBuffer): Unit = Unit
    override fun uniform4i(location: Int, v0: Int, v1: Int, v2: Int, v3: Int): Unit = Unit
    override fun uniform4iv(location: Int, count: Int, value: NBuffer): Unit = Unit
    override fun uniformMatrix2fv(location: Int, count: Int, transpose: Boolean, value: NBuffer): Unit = Unit
    override fun uniformMatrix3fv(location: Int, count: Int, transpose: Boolean, value: NBuffer): Unit = Unit
    override fun uniformMatrix4fv(location: Int, count: Int, transpose: Boolean, value: NBuffer): Unit = Unit
    ...
    override fun vertexAttrib1fv(index: Int, v: NBuffer): Unit = Unit
    override fun vertexAttrib2f(index: Int, x: Float, y: Float): Unit = Unit
    override fun vertexAttrib2fv(index: Int, v: NBuffer): Unit = Unit
    override fun vertexAttrib3f(index: Int, x: Float, y: Float, z: Float): Unit = Unit
    override fun vertexAttrib3fv(index: Int, v: NBuffer): Unit = Unit
    override fun vertexAttrib4f(index: Int, x: Float, y: Float, z: Float, w: Float): Unit = Unit
    override fun vertexAttrib4fv(index: Int, v: NBuffer): Unit = Unit
