...
interface IKmlGl {
	...
	fun bufferData(target: Int, size: Int, data: NBuffer, usage: Int): Unit
	fun bufferSubData(target: Int, offset: Int, size: Int, data: NBuffer): Unit
	...
	fun compressedTexImage2D(target: Int, level: Int, internalformat: Int, width: Int, height: Int, border: Int, imageSize: Int, data: NBuffer): Unit
	fun compressedTexSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int, width: Int, height: Int, format: Int, imageSize: Int, data: NBuffer): Unit
	...
	fun deleteBuffers(n: Int, items: NBuffer): Unit
	fun deleteFramebuffers(n: Int, items: NBuffer): Unit
	fun deleteProgram(program: Int): Unit
	fun deleteRenderbuffers(n: Int, items: NBuffer): Unit
	fun deleteShader(shader: Int): Unit
	fun deleteTextures(n: Int, items: NBuffer): Unit
	...
	fun genBuffers(n: Int, buffers: NBuffer): Unit
	fun generateMipmap(target: Int): Unit
	fun genFramebuffers(n: Int, framebuffers: NBuffer): Unit
	fun genRenderbuffers(n: Int, renderbuffers: NBuffer): Unit
	fun genTextures(n: Int, textures: NBuffer): Unit
	fun getActiveAttrib(program: Int, index: Int, bufSize: Int, length: NBuffer, size: NBuffer, type: NBuffer, name: NBuffer): Unit
	fun getActiveUniform(program: Int, index: Int, bufSize: Int, length: NBuffer, size: NBuffer, type: NBuffer, name: NBuffer): Unit
	fun getAttachedShaders(program: Int, maxCount: Int, count: NBuffer, shaders: NBuffer): Unit
	fun getAttribLocation(program: Int, name: String): Int
	fun getUniformLocation(program: Int, name: String): Int
	fun getBooleanv(pname: Int, data: NBuffer): Unit
	fun getBufferParameteriv(target: Int, pname: Int, params: NBuffer): Unit
	fun getError(): Int
	fun getFloatv(pname: Int, data: NBuffer): Unit
	fun getFramebufferAttachmentParameteriv(target: Int, attachment: Int, pname: Int, params: NBuffer): Unit
	fun getIntegerv(pname: Int, data: NBuffer): Unit
	fun getProgramInfoLog(program: Int, bufSize: Int, length: NBuffer, infoLog: NBuffer): Unit
	fun getRenderbufferParameteriv(target: Int, pname: Int, params: NBuffer): Unit
	fun getProgramiv(program: Int, pname: Int, params: NBuffer): Unit
	fun getShaderiv(shader: Int, pname: Int, params: NBuffer): Unit
	fun getShaderInfoLog(shader: Int, bufSize: Int, length: NBuffer, infoLog: NBuffer): Unit
	fun getShaderPrecisionFormat(shadertype: Int, precisiontype: Int, range: NBuffer, precision: NBuffer): Unit
	fun getShaderSource(shader: Int, bufSize: Int, length: NBuffer, source: NBuffer): Unit
	fun getString(name: Int): String
	fun getTexParameterfv(target: Int, pname: Int, params: NBuffer): Unit
	fun getTexParameteriv(target: Int, pname: Int, params: NBuffer): Unit
	fun getUniformfv(program: Int, location: Int, params: NBuffer): Unit
	fun getUniformiv(program: Int, location: Int, params: NBuffer): Unit
	fun getVertexAttribfv(index: Int, pname: Int, params: NBuffer): Unit
	fun getVertexAttribiv(index: Int, pname: Int, params: NBuffer): Unit
	fun getVertexAttribPointerv(index: Int, pname: Int, pointer: NBuffer): Unit
	...
	fun readPixels(x: Int, y: Int, width: Int, height: Int, format: Int, type: Int, pixels: NBuffer): Unit
	...
	fun shaderBinary(count: Int, shaders: NBuffer, binaryformat: Int, binary: NBuffer, length: Int): Unit
	...
	fun texImage2D(target: Int, level: Int, internalformat: Int, width: Int, height: Int, border: Int, format: Int, type: Int, pixels: NBuffer?): Unit
	...
	fun texParameterfv(target: Int, pname: Int, params: NBuffer): Unit
	fun texParameteri(target: Int, pname: Int, param: Int): Unit
	fun texParameteriv(target: Int, pname: Int, params: NBuffer): Unit
	fun texSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int, width: Int, height: Int, format: Int, type: Int, pixels: NBuffer): Unit
	fun uniform1f(location: Int, v0: Float): Unit
	fun uniform1fv(location: Int, count: Int, value: NBuffer): Unit
	fun uniform1i(location: Int, v0: Int): Unit
	fun uniform1iv(location: Int, count: Int, value: NBuffer): Unit
	fun uniform2f(location: Int, v0: Float, v1: Float): Unit
	fun uniform2fv(location: Int, count: Int, value: NBuffer): Unit
	fun uniform2i(location: Int, v0: Int, v1: Int): Unit
	fun uniform2iv(location: Int, count: Int, value: NBuffer): Unit
	fun uniform3f(location: Int, v0: Float, v1: Float, v2: Float): Unit
	fun uniform3fv(location: Int, count: Int, value: NBuffer): Unit
	fun uniform3i(location: Int, v0: Int, v1: Int, v2: Int): Unit
	fun uniform3iv(location: Int, count: Int, value: NBuffer): Unit
	fun uniform4f(location: Int, v0: Float, v1: Float, v2: Float, v3: Float): Unit
	fun uniform4fv(location: Int, count: Int, value: NBuffer): Unit
	fun uniform4i(location: Int, v0: Int, v1: Int, v2: Int, v3: Int): Unit
	fun uniform4iv(location: Int, count: Int, value: NBuffer): Unit
	fun uniformMatrix2fv(location: Int, count: Int, transpose: Boolean, value: NBuffer): Unit
	fun uniformMatrix3fv(location: Int, count: Int, transpose: Boolean, value: NBuffer): Unit
	fun uniformMatrix4fv(location: Int, count: Int, transpose: Boolean, value: NBuffer): Unit
	fun useProgram(program: Int): Unit
	fun validateProgram(program: Int): Unit
	fun vertexAttrib1f(index: Int, x: Float): Unit
	fun vertexAttrib1fv(index: Int, v: NBuffer): Unit
	fun vertexAttrib2f(index: Int, x: Float, y: Float): Unit
	fun vertexAttrib2fv(index: Int, v: NBuffer): Unit
	fun vertexAttrib3f(index: Int, x: Float, y: Float, z: Float): Unit
	fun vertexAttrib3fv(index: Int, v: NBuffer): Unit
	fun vertexAttrib4f(index: Int, x: Float, y: Float, z: Float, w: Float): Unit
	fun vertexAttrib4fv(index: Int, v: NBuffer): Unit
