...
class JvmKmlGl(val gl: GL2) : KmlGl() {
    ...
    override fun bufferData(target: Int, size: Int, data: NBuffer, usage: Int): Unit = gl.glBufferData(target, size.toLong(), data.nioBuffer, usage)
    override fun bufferSubData(target: Int, offset: Int, size: Int, data: NBuffer): Unit = gl.glBufferSubData(target, offset.toLong(), size.toLong(), data.nioBuffer)
    ...
    override fun compressedTexImage2D(target: Int, level: Int, internalformat: Int, width: Int, height: Int, border: Int, imageSize: Int, data: NBuffer): Unit = gl.glCompressedTexImage2D(target, level, internalformat, width, height, border, imageSize, data.nioBuffer)
    override fun compressedTexSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int, width: Int, height: Int, format: Int, imageSize: Int, data: NBuffer): Unit = gl.glCompressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, imageSize, data.nioBuffer)
    ...
    override fun deleteBuffers(n: Int, items: NBuffer): Unit = gl.glDeleteBuffers(n, items.nioIntBuffer)
    override fun deleteFramebuffers(n: Int, items: NBuffer): Unit = gl.glDeleteFramebuffers(n, items.nioIntBuffer)
    override fun deleteProgram(program: Int): Unit = gl.glDeleteProgram(program)
    override fun deleteRenderbuffers(n: Int, items: NBuffer): Unit = gl.glDeleteRenderbuffers(n, items.nioIntBuffer)
    override fun deleteShader(shader: Int): Unit = gl.glDeleteShader(shader)
    override fun deleteTextures(n: Int, items: NBuffer): Unit = gl.glDeleteTextures(n, items.nioIntBuffer)
    ...
    override fun genBuffers(n: Int, buffers: NBuffer): Unit = gl.glGenBuffers(n, buffers.nioIntBuffer)
    override fun generateMipmap(target: Int): Unit = gl.glGenerateMipmap(target)
    override fun genFramebuffers(n: Int, framebuffers: NBuffer): Unit = gl.glGenFramebuffers(n, framebuffers.nioIntBuffer)
    override fun genRenderbuffers(n: Int, renderbuffers: NBuffer): Unit = gl.glGenRenderbuffers(n, renderbuffers.nioIntBuffer)
    override fun genTextures(n: Int, textures: NBuffer): Unit = gl.glGenTextures(n, textures.nioIntBuffer)
    override fun getActiveAttrib(program: Int, index: Int, bufSize: Int, length: NBuffer, size: NBuffer, type: NBuffer, name: NBuffer): Unit = gl.glGetActiveAttrib(program, index, bufSize, length.nioIntBuffer, size.nioIntBuffer, type.nioIntBuffer, name.nioBuffer)
    override fun getActiveUniform(program: Int, index: Int, bufSize: Int, length: NBuffer, size: NBuffer, type: NBuffer, name: NBuffer): Unit = gl.glGetActiveUniform(program, index, bufSize, length.nioIntBuffer, size.nioIntBuffer, type.nioIntBuffer, name.nioBuffer)
    override fun getAttachedShaders(program: Int, maxCount: Int, count: NBuffer, shaders: NBuffer): Unit = gl.glGetAttachedShaders(program, maxCount, count.nioIntBuffer, shaders.nioIntBuffer)
    ...
    override fun getBooleanv(pname: Int, data: NBuffer): Unit = gl.glGetBooleanv(pname, data.nioBuffer)
    override fun getBufferParameteriv(target: Int, pname: Int, params: NBuffer): Unit = gl.glGetBufferParameteriv(target, pname, params.nioIntBuffer)
    override fun getError(): Int = gl.glGetError()
    override fun getFloatv(pname: Int, data: NBuffer): Unit = gl.glGetFloatv(pname, data.nioFloatBuffer)
    override fun getFramebufferAttachmentParameteriv(target: Int, attachment: Int, pname: Int, params: NBuffer): Unit = gl.glGetFramebufferAttachmentParameteriv(target, attachment, pname, params.nioIntBuffer)
    override fun getIntegerv(pname: Int, data: NBuffer): Unit = gl.glGetIntegerv(pname, data.nioIntBuffer)
    override fun getProgramInfoLog(program: Int, bufSize: Int, length: NBuffer, infoLog: NBuffer): Unit = gl.glGetProgramInfoLog(program, bufSize, length.nioIntBuffer, infoLog.nioBuffer)
    override fun getRenderbufferParameteriv(target: Int, pname: Int, params: NBuffer): Unit = gl.glGetRenderbufferParameteriv(target, pname, params.nioIntBuffer)
    override fun getProgramiv(program: Int, pname: Int, params: NBuffer): Unit = gl.glGetProgramiv(program, pname, params.nioIntBuffer)
    override fun getShaderiv(shader: Int, pname: Int, params: NBuffer): Unit = gl.glGetShaderiv(shader, pname, params.nioIntBuffer)
    override fun getShaderInfoLog(shader: Int, bufSize: Int, length: NBuffer, infoLog: NBuffer): Unit = gl.glGetShaderInfoLog(shader, bufSize, length.nioIntBuffer, infoLog.nioBuffer)
    override fun getShaderPrecisionFormat(shadertype: Int, precisiontype: Int, range: NBuffer, precision: NBuffer): Unit = gl.glGetShaderPrecisionFormat(shadertype, precisiontype, range.nioIntBuffer, precision.nioIntBuffer)
    override fun getShaderSource(shader: Int, bufSize: Int, length: NBuffer, source: NBuffer): Unit = gl.glGetShaderSource(shader, bufSize, length.nioIntBuffer, source.nioBuffer)
    override fun getString(name: Int): String = gl.glGetString(name)
    override fun getTexParameterfv(target: Int, pname: Int, params: NBuffer): Unit = gl.glGetTexParameterfv(target, pname, params.nioFloatBuffer)
    override fun getTexParameteriv(target: Int, pname: Int, params: NBuffer): Unit = gl.glGetTexParameteriv(target, pname, params.nioIntBuffer)
    override fun getUniformfv(program: Int, location: Int, params: NBuffer): Unit = gl.glGetUniformfv(program, location, params.nioFloatBuffer)
    override fun getUniformiv(program: Int, location: Int, params: NBuffer): Unit = gl.glGetUniformiv(program, location, params.nioIntBuffer)
    override fun getVertexAttribfv(index: Int, pname: Int, params: NBuffer): Unit = gl.glGetVertexAttribfv(index, pname, params.nioFloatBuffer)
    override fun getVertexAttribiv(index: Int, pname: Int, params: NBuffer): Unit = gl.glGetVertexAttribiv(index, pname, params.nioIntBuffer)
    override fun getVertexAttribPointerv(index: Int, pname: Int, pointer: NBuffer): Unit = gl.glGetVertexAttribiv(index, pname, pointer.nioIntBuffer)
    ...
    override fun readPixels(x: Int, y: Int, width: Int, height: Int, format: Int, type: Int, pixels: NBuffer): Unit = gl.glReadPixels(x, y, width, height, format, type, pixels.nioBuffer)
    ...
    override fun shaderBinary(count: Int, shaders: NBuffer, binaryformat: Int, binary: NBuffer, length: Int): Unit = gl.glShaderBinary(count, shaders.nioIntBuffer, binaryformat, binary.nioBuffer, length)
    ...
    override fun texImage2D(target: Int, level: Int, internalformat: Int, width: Int, height: Int, border: Int, format: Int, type: Int, pixels: NBuffer?): Unit = gl.glTexImage2D(target, level, internalformat, width, height, border, format, type, pixels?.nioBuffer)
    ...
    override fun texParameterfv(target: Int, pname: Int, params: NBuffer): Unit = gl.glTexParameterfv(target, pname, params.nioFloatBuffer)
    override fun texParameteri(target: Int, pname: Int, param: Int): Unit = gl.glTexParameteri(target, pname, param)
    override fun texParameteriv(target: Int, pname: Int, params: NBuffer): Unit = gl.glTexParameteriv(target, pname, params.nioIntBuffer)
    override fun texSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int, width: Int, height: Int, format: Int, type: Int, pixels: NBuffer): Unit = gl.glTexSubImage2D(target, level, xoffset, yoffset, width, height, format, type, pixels.nioBuffer)
    override fun uniform1f(location: Int, v0: Float): Unit = gl.glUniform1f(location, v0)
    override fun uniform1fv(location: Int, count: Int, value: NBuffer): Unit = gl.glUniform1fv(location, count, value.nioFloatBuffer)
    override fun uniform1i(location: Int, v0: Int): Unit = gl.glUniform1i(location, v0)
    override fun uniform1iv(location: Int, count: Int, value: NBuffer): Unit = gl.glUniform1iv(location, count, value.nioIntBuffer)
    override fun uniform2f(location: Int, v0: Float, v1: Float): Unit = gl.glUniform2f(location, v0, v1)
    override fun uniform2fv(location: Int, count: Int, value: NBuffer): Unit = gl.glUniform2fv(location, count, value.nioFloatBuffer)
    override fun uniform2i(location: Int, v0: Int, v1: Int): Unit = gl.glUniform2i(location, v0, v1)
    override fun uniform2iv(location: Int, count: Int, value: NBuffer): Unit = gl.glUniform2iv(location, count, value.nioIntBuffer)
    override fun uniform3f(location: Int, v0: Float, v1: Float, v2: Float): Unit = gl.glUniform3f(location, v0, v1, v2)
    override fun uniform3fv(location: Int, count: Int, value: NBuffer): Unit = gl.glUniform3fv(location, count, value.nioFloatBuffer)
    override fun uniform3i(location: Int, v0: Int, v1: Int, v2: Int): Unit = gl.glUniform3i(location, v0, v1, v2)
    override fun uniform3iv(location: Int, count: Int, value: NBuffer): Unit = gl.glUniform3iv(location, count, value.nioIntBuffer)
    override fun uniform4f(location: Int, v0: Float, v1: Float, v2: Float, v3: Float): Unit = gl.glUniform4f(location, v0, v1, v2, v3)
    override fun uniform4fv(location: Int, count: Int, value: NBuffer): Unit = gl.glUniform4fv(location, count, value.nioFloatBuffer)
    override fun uniform4i(location: Int, v0: Int, v1: Int, v2: Int, v3: Int): Unit = gl.glUniform4i(location, v0, v1, v2, v3)
    override fun uniform4iv(location: Int, count: Int, value: NBuffer): Unit = gl.glUniform4iv(location, count, value.nioIntBuffer)
    override fun uniformMatrix2fv(location: Int, count: Int, transpose: Boolean, value: NBuffer): Unit = gl.glUniformMatrix2fv(location, count, transpose, value.nioFloatBuffer)
    override fun uniformMatrix3fv(location: Int, count: Int, transpose: Boolean, value: NBuffer): Unit = gl.glUniformMatrix3fv(location, count, transpose, value.nioFloatBuffer)
    override fun uniformMatrix4fv(location: Int, count: Int, transpose: Boolean, value: NBuffer): Unit = gl.glUniformMatrix4fv(location, count, transpose, value.nioFloatBuffer)
    ...
    override fun vertexAttrib1fv(index: Int, v: NBuffer): Unit = gl.glVertexAttrib1fv(index, v.nioFloatBuffer)
    override fun vertexAttrib2f(index: Int, x: Float, y: Float): Unit = gl.glVertexAttrib2f(index, x, y)
    override fun vertexAttrib2fv(index: Int, v: NBuffer): Unit = gl.glVertexAttrib2fv(index, v.nioFloatBuffer)
    override fun vertexAttrib3f(index: Int, x: Float, y: Float, z: Float): Unit = gl.glVertexAttrib3f(index, x, y, z)
    override fun vertexAttrib3fv(index: Int, v: NBuffer): Unit = gl.glVertexAttrib3fv(index, v.nioFloatBuffer)
    override fun vertexAttrib4f(index: Int, x: Float, y: Float, z: Float, w: Float): Unit = gl.glVertexAttrib4f(index, x, y, z, w)
    override fun vertexAttrib4fv(index: Int, v: NBuffer): Unit = gl.glVertexAttrib4fv(index, v.nioFloatBuffer)
