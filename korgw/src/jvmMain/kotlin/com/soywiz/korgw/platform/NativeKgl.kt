...
open class NativeKgl(private val gl: INativeGL) : KmlGlWithExtensions() {
    ...
    override fun bufferData(target: Int, size: Int, data: Buffer, usage: Int): Unit = gl.glBufferData(target, NativeLong(size.toLong()), data.directBuffer, usage)
    override fun bufferSubData(target: Int, offset: Int, size: Int, data: Buffer): Unit = gl.glBufferSubData(target, NativeLong(offset.toLong()), NativeLong(size.toLong()), data.directBuffer)
    ...
    override fun compressedTexImage2D(target: Int, level: Int, internalformat: Int, width: Int, height: Int, border: Int, imageSize: Int, data: Buffer): Unit = gl.glCompressedTexImage2D(target, level, internalformat, width, height, border, imageSize, data.directBuffer)
    override fun compressedTexSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int, width: Int, height: Int, format: Int, imageSize: Int, data: Buffer): Unit = gl.glCompressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, imageSize, data.directBuffer)
    ...
    override fun getActiveAttrib(program: Int, index: Int, bufSize: Int, length: Buffer, size: Buffer, type: Buffer, name: Buffer): Unit = gl.glGetActiveAttrib(program, index, bufSize, length.directIntBuffer, size.directIntBuffer, type.directIntBuffer, name.directBuffer)
    override fun getActiveUniform(program: Int, index: Int, bufSize: Int, length: Buffer, size: Buffer, type: Buffer, name: Buffer): Unit = gl.glGetActiveUniform(program, index, bufSize, length.directIntBuffer, size.directIntBuffer, type.directIntBuffer, name.directBuffer)
    ...
    override fun getBooleanv(pname: Int, data: Buffer): Unit = gl.glGetBooleanv(pname, data.directBuffer)
    ...
    override fun getProgramInfoLog(program: Int, bufSize: Int, length: Buffer, infoLog: Buffer): Unit = gl.glGetProgramInfoLog(program, bufSize, length.directIntBuffer, infoLog.directBuffer)
    ...
    override fun getShaderInfoLog(shader: Int, bufSize: Int, length: Buffer, infoLog: Buffer): Unit = gl.glGetShaderInfoLog(shader, bufSize, length.directIntBuffer, infoLog.directBuffer)
    ...
    override fun getShaderSource(shader: Int, bufSize: Int, length: Buffer, source: Buffer): Unit = gl.glGetShaderSource(shader, bufSize, length.directIntBuffer, source.directBuffer)
    ...
    override fun readPixels(x: Int, y: Int, width: Int, height: Int, format: Int, type: Int, pixels: Buffer): Unit = gl.glReadPixels(x, y, width, height, format, type, pixels.directBuffer)
    ...
    override fun shaderBinary(count: Int, shaders: Buffer, binaryformat: Int, binary: Buffer, length: Int): Unit = gl.glShaderBinary(count, shaders.directIntBuffer, binaryformat, binary.directBuffer, length)
    ...
    override fun texImage2D(target: Int, level: Int, internalformat: Int, width: Int, height: Int, border: Int, format: Int, type: Int, pixels: Buffer?): Unit = gl.glTexImage2D(target, level, internalformat, width, height, border, format, type, pixels?.directBuffer)
    ...
    override fun texSubImage2D(target: Int, level: Int, xoffset: Int, yoffset: Int, width: Int, height: Int, format: Int, type: Int, pixels: Buffer): Unit = gl.glTexSubImage2D(target, level, xoffset, yoffset, width, height, format, type, pixels.directBuffer)
