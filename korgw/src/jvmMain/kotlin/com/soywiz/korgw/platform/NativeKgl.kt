...
open class NativeKgl(private val gl: INativeGL) : KmlGlWithExtensions() {
    ...
    override fun bufferData(target: Int, size: Int, data: NBuffer, usage: Int): Unit = gl.glBufferData(target, NativeLong(size.toLong()), data.nioBuffer, usage)
    override fun bufferSubData(target: Int, offset: Int, size: Int, data: NBuffer): Unit = gl.glBufferSubData(target, NativeLong(offset.toLong()), NativeLong(size.toLong()), data.nioBuffer)
    ...
    override fun uniformMatrix2fv(location: Int, count: Int, transpose: Boolean, value: NBuffer): Unit = gl.glUniformMatrix2fv(location, count, transpose.toByte(), value.nioFloatBuffer.slice(0, 4 * count))
    override fun uniformMatrix3fv(location: Int, count: Int, transpose: Boolean, value: NBuffer): Unit = gl.glUniformMatrix3fv(location, count, transpose.toByte(), value.nioFloatBuffer.slice(0, 9 * count))
    override fun uniformMatrix4fv(location: Int, count: Int, transpose: Boolean, value: NBuffer): Unit = gl.glUniformMatrix4fv(location, count, transpose.toByte(), value.nioFloatBuffer.slice(0, 16 * count))
