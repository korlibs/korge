...
class JoglGameWindow : GameWindow() {
    ...
    private fun dispatchME(e: java.awt.event.MouseEvent, type: korlibs.event.MouseEvent.Type) {
        dispatch(mouseEvent {
            this.type = type
            this.id = 0
            this.x = e.x
    ...
    private fun dispatchKE(e: java.awt.event.KeyEvent, type: korlibs.event.KeyEvent.Type) {
        dispatch(keyEvent {
            this.type = type
            this.id = 0
    ...
    override suspend fun loop(entry: suspend GameWindow.() -> Unit) {
        ...
        val motionListener = object : MouseMotionAdapter() {
            override fun mouseMoved(e: java.awt.event.MouseEvent) = dispatchME(e, korlibs.event.MouseEvent.Type.MOVE)
            override fun mouseDragged(e: java.awt.event.MouseEvent) = dispatchME(e, korlibs.event.MouseEvent.Type.DRAG)
        }
        val mouseListener = object : MouseAdapter() {
            override fun mousePressed(e: java.awt.event.MouseEvent) =
                dispatchME(e, korlibs.event.MouseEvent.Type.DOWN)

            override fun mouseReleased(e: java.awt.event.MouseEvent) =
                dispatchME(e, korlibs.event.MouseEvent.Type.UP)

            override fun mouseMoved(e: java.awt.event.MouseEvent) = dispatchME(e, korlibs.event.MouseEvent.Type.MOVE)
            override fun mouseEntered(e: java.awt.event.MouseEvent) =
                dispatchME(e, korlibs.event.MouseEvent.Type.ENTER)

            override fun mouseDragged(e: java.awt.event.MouseEvent) =
                dispatchME(e, korlibs.event.MouseEvent.Type.DRAG)

            override fun mouseClicked(e: java.awt.event.MouseEvent) =
                dispatchME(e, korlibs.event.MouseEvent.Type.CLICK)

            override fun mouseExited(e: java.awt.event.MouseEvent) =
                dispatchME(e, korlibs.event.MouseEvent.Type.EXIT)
        ...
        val keyListener = object : KeyListener {
            override fun keyTyped(e: KeyEvent) = dispatchKE(e, korlibs.event.KeyEvent.Type.TYPE)
            override fun keyPressed(e: KeyEvent) = dispatchKE(e, korlibs.event.KeyEvent.Type.DOWN)
            override fun keyReleased(e: KeyEvent) = dispatchKE(e, korlibs.event.KeyEvent.Type.UP)
        }
...
class JvmKmlGl(val gl: GL2) : KmlGl() {
    ...
    override fun bufferData(target: Int, size: Int, data: Buffer, usage: Int): Unit = gl.glBufferData(target, size.toLong(), data.nioBuffer, usage)
    override fun bufferSubData(target: Int, offset: Int, size: Int, data: Buffer): Unit = gl.glBufferSubData(target, offset.toLong(), size.toLong(), data.nioBuffer)
    ...
    override fun deleteBuffers(n: Int, items: Buffer): Unit = gl.glDeleteBuffers(n, items.nioIntBuffer)
    override fun deleteFramebuffers(n: Int, items: Buffer): Unit = gl.glDeleteFramebuffers(n, items.nioIntBuffer)
    override fun deleteProgram(program: Int): Unit = gl.glDeleteProgram(program)
    override fun deleteRenderbuffers(n: Int, items: Buffer): Unit = gl.glDeleteRenderbuffers(n, items.nioIntBuffer)
    override fun deleteShader(shader: Int): Unit = gl.glDeleteShader(shader)
    override fun deleteTextures(n: Int, items: Buffer): Unit = gl.glDeleteTextures(n, items.nioIntBuffer)
    ...
    override fun genBuffers(n: Int, buffers: Buffer): Unit = gl.glGenBuffers(n, buffers.nioIntBuffer)
    override fun generateMipmap(target: Int): Unit = gl.glGenerateMipmap(target)
    override fun genFramebuffers(n: Int, framebuffers: Buffer): Unit = gl.glGenFramebuffers(n, framebuffers.nioIntBuffer)
    override fun genRenderbuffers(n: Int, renderbuffers: Buffer): Unit = gl.glGenRenderbuffers(n, renderbuffers.nioIntBuffer)
    override fun genTextures(n: Int, textures: Buffer): Unit = gl.glGenTextures(n, textures.nioIntBuffer)
    override fun getActiveAttrib(program: Int, index: Int, bufSize: Int, length: Buffer, size: Buffer, type: Buffer, name: Buffer): Unit = gl.glGetActiveAttrib(program, index, bufSize, length.nioIntBuffer, size.nioIntBuffer, type.nioIntBuffer, name.nioBuffer)
    override fun getActiveUniform(program: Int, index: Int, bufSize: Int, length: Buffer, size: Buffer, type: Buffer, name: Buffer): Unit = gl.glGetActiveUniform(program, index, bufSize, length.nioIntBuffer, size.nioIntBuffer, type.nioIntBuffer, name.nioBuffer)
    override fun getAttachedShaders(program: Int, maxCount: Int, count: Buffer, shaders: Buffer): Unit = gl.glGetAttachedShaders(program, maxCount, count.nioIntBuffer, shaders.nioIntBuffer)
    ...
    override fun getBufferParameteriv(target: Int, pname: Int, params: Buffer): Unit = gl.glGetBufferParameteriv(target, pname, params.nioIntBuffer)
    override fun getError(): Int = gl.glGetError()
    override fun getFloatv(pname: Int, data: Buffer): Unit = gl.glGetFloatv(pname, data.nioFloatBuffer)
    override fun getFramebufferAttachmentParameteriv(target: Int, attachment: Int, pname: Int, params: Buffer): Unit = gl.glGetFramebufferAttachmentParameteriv(target, attachment, pname, params.nioIntBuffer)
    override fun getIntegerv(pname: Int, data: Buffer): Unit = gl.glGetIntegerv(pname, data.nioIntBuffer)
    override fun getProgramInfoLog(program: Int, bufSize: Int, length: Buffer, infoLog: Buffer): Unit = gl.glGetProgramInfoLog(program, bufSize, length.nioIntBuffer, infoLog.nioBuffer)
    override fun getRenderbufferParameteriv(target: Int, pname: Int, params: Buffer): Unit = gl.glGetRenderbufferParameteriv(target, pname, params.nioIntBuffer)
    override fun getProgramiv(program: Int, pname: Int, params: Buffer): Unit = gl.glGetProgramiv(program, pname, params.nioIntBuffer)
    override fun getShaderiv(shader: Int, pname: Int, params: Buffer): Unit = gl.glGetShaderiv(shader, pname, params.nioIntBuffer)
    override fun getShaderInfoLog(shader: Int, bufSize: Int, length: Buffer, infoLog: Buffer): Unit = gl.glGetShaderInfoLog(shader, bufSize, length.nioIntBuffer, infoLog.nioBuffer)
    override fun getShaderPrecisionFormat(shadertype: Int, precisiontype: Int, range: Buffer, precision: Buffer): Unit = gl.glGetShaderPrecisionFormat(shadertype, precisiontype, range.nioIntBuffer, precision.nioIntBuffer)
    override fun getShaderSource(shader: Int, bufSize: Int, length: Buffer, source: Buffer): Unit = gl.glGetShaderSource(shader, bufSize, length.nioIntBuffer, source.nioBuffer)
    override fun getString(name: Int): String = gl.glGetString(name)
    override fun getTexParameterfv(target: Int, pname: Int, params: Buffer): Unit = gl.glGetTexParameterfv(target, pname, params.nioFloatBuffer)
    override fun getTexParameteriv(target: Int, pname: Int, params: Buffer): Unit = gl.glGetTexParameteriv(target, pname, params.nioIntBuffer)
    override fun getUniformfv(program: Int, location: Int, params: Buffer): Unit = gl.glGetUniformfv(program, location, params.nioFloatBuffer)
    override fun getUniformiv(program: Int, location: Int, params: Buffer): Unit = gl.glGetUniformiv(program, location, params.nioIntBuffer)
    override fun getVertexAttribfv(index: Int, pname: Int, params: Buffer): Unit = gl.glGetVertexAttribfv(index, pname, params.nioFloatBuffer)
    override fun getVertexAttribiv(index: Int, pname: Int, params: Buffer): Unit = gl.glGetVertexAttribiv(index, pname, params.nioIntBuffer)
    override fun getVertexAttribPointerv(index: Int, pname: Int, pointer: Buffer): Unit = gl.glGetVertexAttribiv(index, pname, pointer.nioIntBuffer)
    ...
    override fun shaderBinary(count: Int, shaders: Buffer, binaryformat: Int, binary: Buffer, length: Int): Unit = gl.glShaderBinary(count, shaders.nioIntBuffer, binaryformat, binary.nioBuffer, length)
    ...
    override fun texParameterfv(target: Int, pname: Int, params: Buffer): Unit = gl.glTexParameterfv(target, pname, params.nioFloatBuffer)
    override fun texParameteri(target: Int, pname: Int, param: Int): Unit = gl.glTexParameteri(target, pname, param)
    override fun texParameteriv(target: Int, pname: Int, params: Buffer): Unit = gl.glTexParameteriv(target, pname, params.nioIntBuffer)
    ...
    override fun uniform1fv(location: Int, count: Int, value: Buffer): Unit = gl.glUniform1fv(location, count, value.nioFloatBuffer)
    override fun uniform1i(location: Int, v0: Int): Unit = gl.glUniform1i(location, v0)
    override fun uniform1iv(location: Int, count: Int, value: Buffer): Unit = gl.glUniform1iv(location, count, value.nioIntBuffer)
    override fun uniform2f(location: Int, v0: Float, v1: Float): Unit = gl.glUniform2f(location, v0, v1)
    override fun uniform2fv(location: Int, count: Int, value: Buffer): Unit = gl.glUniform2fv(location, count, value.nioFloatBuffer)
    override fun uniform2i(location: Int, v0: Int, v1: Int): Unit = gl.glUniform2i(location, v0, v1)
    override fun uniform2iv(location: Int, count: Int, value: Buffer): Unit = gl.glUniform2iv(location, count, value.nioIntBuffer)
    override fun uniform3f(location: Int, v0: Float, v1: Float, v2: Float): Unit = gl.glUniform3f(location, v0, v1, v2)
    override fun uniform3fv(location: Int, count: Int, value: Buffer): Unit = gl.glUniform3fv(location, count, value.nioFloatBuffer)
    override fun uniform3i(location: Int, v0: Int, v1: Int, v2: Int): Unit = gl.glUniform3i(location, v0, v1, v2)
    override fun uniform3iv(location: Int, count: Int, value: Buffer): Unit = gl.glUniform3iv(location, count, value.nioIntBuffer)
    override fun uniform4f(location: Int, v0: Float, v1: Float, v2: Float, v3: Float): Unit = gl.glUniform4f(location, v0, v1, v2, v3)
    override fun uniform4fv(location: Int, count: Int, value: Buffer): Unit = gl.glUniform4fv(location, count, value.nioFloatBuffer)
    override fun uniform4i(location: Int, v0: Int, v1: Int, v2: Int, v3: Int): Unit = gl.glUniform4i(location, v0, v1, v2, v3)
    override fun uniform4iv(location: Int, count: Int, value: Buffer): Unit = gl.glUniform4iv(location, count, value.nioIntBuffer)
    override fun uniformMatrix2fv(location: Int, count: Int, transpose: Boolean, value: Buffer): Unit = gl.glUniformMatrix2fv(location, count, transpose, value.nioFloatBuffer)
    override fun uniformMatrix3fv(location: Int, count: Int, transpose: Boolean, value: Buffer): Unit = gl.glUniformMatrix3fv(location, count, transpose, value.nioFloatBuffer)
    override fun uniformMatrix4fv(location: Int, count: Int, transpose: Boolean, value: Buffer): Unit = gl.glUniformMatrix4fv(location, count, transpose, value.nioFloatBuffer)
    ...
    override fun vertexAttrib1fv(index: Int, v: Buffer): Unit = gl.glVertexAttrib1fv(index, v.nioFloatBuffer)
    override fun vertexAttrib2f(index: Int, x: Float, y: Float): Unit = gl.glVertexAttrib2f(index, x, y)
    override fun vertexAttrib2fv(index: Int, v: Buffer): Unit = gl.glVertexAttrib2fv(index, v.nioFloatBuffer)
    override fun vertexAttrib3f(index: Int, x: Float, y: Float, z: Float): Unit = gl.glVertexAttrib3f(index, x, y, z)
    override fun vertexAttrib3fv(index: Int, v: Buffer): Unit = gl.glVertexAttrib3fv(index, v.nioFloatBuffer)
    override fun vertexAttrib4f(index: Int, x: Float, y: Float, z: Float, w: Float): Unit = gl.glVertexAttrib4f(index, x, y, z, w)
    override fun vertexAttrib4fv(index: Int, v: Buffer): Unit = gl.glVertexAttrib4fv(index, v.nioFloatBuffer)
