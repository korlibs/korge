...
class KmlGlJsCanvas(val canvas: HTMLCanvasElement, val glOpts: dynamic) : KmlGlWithExtensions() {
    ...
    override fun uniformMatrix2fv(location: Int, count: Int, transpose: Boolean, value: Buffer): Unit = gl.uniformMatrix2fv(location.get(), transpose, value.arrayFloat)
    override fun uniformMatrix3fv(location: Int, count: Int, transpose: Boolean, value: Buffer): Unit = gl.uniformMatrix3fv(location.get(), transpose, value.arrayFloat)
    override fun uniformMatrix4fv(location: Int, count: Int, transpose: Boolean, value: Buffer): Unit = gl.uniformMatrix4fv(location.get(), transpose, value.arrayFloat)
